...
public class DBUtils {
    public static void changeScene(ActionEvent event, String fxmlFile,String title, String username, String sex){
        Parent root = null;
    ...
    public static void signUpUser(ActionEvent event, String username, String password,String sex){
        ...
        try{
            ...
            if (resultSet.isBeforeFirst()){
                ...
                psInsert = connection.prepareStatement("INSERT INTO users (username, password, sex (?, ?, ?)");
            ...
            if (!resultSet.isBeforeFirst()){
                ...
                while(resultSet.next()) {
                    ...
                    if(retrievedPassword.equals(password)){
                        changeScene(event,"hello-view.fxml","Calendar", username, retrievedSex);
                    }else{
